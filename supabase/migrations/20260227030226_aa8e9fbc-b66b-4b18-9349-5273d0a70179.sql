...
-- Drop the OLD overload that uses DATE types (causes PGRST203 ambiguity)
DROP FUNCTION IF EXISTS public.search_licitacoes(text, text, text, text, text, text, date, date, integer, integer);

-- Recreate the function with proper TEXT types and explicit casting
